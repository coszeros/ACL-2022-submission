...
class EquityFreezeEvent(BaseEvent):
    ...
    #     'UnfrozeDate',
    # ]
    FIELDS = ['EquityHolder', 'FrozeShares', 'LegalInstitution', 'StartDate', 'TotalHoldingShares',
              'TotalHoldingRatio', 'EndDate', 'UnfrozeDate']
...
class EquityRepurchaseEvent(BaseEvent):
    ...
    #     'RepurchaseAmount',
    # ]
    FIELDS = ['CompanyName', 'RepurchasedShares', 'RepurchaseAmount', 'ClosingDate',
...
class EquityPledgeEvent(BaseEvent):
    ...
    #     'ReleasedDate',
    # ]
    FIELDS = ['Pledger', 'PledgedShares', 'Pledgee', 'StartDate', 'TotalHoldingShares',
              'TotalHoldingRatio', 'TotalPledgedShares', 'EndDate', 'ReleasedDate']
