...
from .utils import default_dump_pkl, default_dump_json, save_json
    ...
    def base_train(self, get_loss_func, kwargs_dict1={},
        ...
        for epoch_idx in trange(base_epoch_idx, int(self.setting.num_train_epochs), desc="Epoch"):
            ...
            if epoch_eval_func is not None:
                if (epoch_idx + 1) % 2 == 0:
                    epoch_eval_func(self, epoch_idx + 1, train_eval=True, **kwargs_dict2)
                else:
                    epoch_eval_func(self, epoch_idx + 1, train_eval=False, **kwargs_dict2)
